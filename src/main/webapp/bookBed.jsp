...
<script>
	function addBookBed() {
		demo.showNotification('top', 'right', 'Success Added Book Bed',
				'success');
	}

	function updateBookBed() {
		demo.showNotification('top', 'right', 'Success Updated Book Bed',
				'success');
	}

	function deleteBookBed() {
		demo.showNotification('top', 'right', 'Success Deleted Book Bed',
				'success');
	}
