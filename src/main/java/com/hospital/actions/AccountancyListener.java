...
public class AccountancyListener {
    ...
    private static final AccountancyListener accountancyListener = new AccountancyListener();

    private static final AccountantDAO accountantDAO = HospitalService.getInstance();
